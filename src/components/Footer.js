    ...
    <>
      <footer className="py-4">
        <div className="container-xxl">
          <div className="row">
            <div className="col-5">
              <div className="footer-top-data d-flex gap-30 elign-items-center">
          ...
          <div className="row">
            <div className="col-4">
              ...
              <address className='text-white fs-6'>
                Hno:288 Near Vill chopal,<br/> Sonipat, Harnay <br/>
                PinCode:1311103
              </address>
              <a href="tel:+91 8264954234" className="mt-3 d-block mb-1 text-white">
                +91 8264954234
              </a>
              <a href="mailto:gungor.ayhan@gmail.com"
               className="mt-2 d-block mb-0 text-white">
                gungor.ayhan@gmail.com
               </a>
          ...
          <div className="row">
            <div className="col-12">
              <p className="text-center mb-0 text-white">
                &copy;{new Date().getFullYear()} Powered by Ayhan Güngör
              </p>
            </div>
          </div>
        </div>
